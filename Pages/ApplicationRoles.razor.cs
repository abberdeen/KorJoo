...
namespace KorJoo.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected IEnumerable<KorJoo.Models.ApplicationRole> roles;
        protected RadzenDataGrid<KorJoo.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(KorJoo.Models.ApplicationRole role)
        {
            try
            {
