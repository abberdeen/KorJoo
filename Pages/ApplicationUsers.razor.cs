...
namespace KorJoo.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<KorJoo.Models.ApplicationUser> users;
        protected RadzenDataGrid<KorJoo.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(KorJoo.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(KorJoo.Models.ApplicationUser user)
        {
            try
            {
