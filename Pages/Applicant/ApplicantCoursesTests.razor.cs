...
{
    public partial class ApplicantCoursesTests
    {
        [Inject]
        ...
        {
            await DialogService.OpenAsync<AddApplicantCoursesTest>("Add ApplicantCoursesTest", null);
            await grid0.Reload();
        }
        ...
        protected async Task GridDeleteButtonClick(MouseEventArgs args, KorJoo.Models.korjoo.ApplicantCoursesTest applicantCoursesTest)
        {
            try
            {
                ...
                {
                    var deleteResult = await korjooService.DeleteApplicantCoursesTest(applicantCoursesTest.Id);
