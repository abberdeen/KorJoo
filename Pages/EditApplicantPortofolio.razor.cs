...
{
    public partial class EditApplicantPortofolio
    {
        [Inject]
        ...
        {
            applicantPortofolio = await korjooService.GetApplicantPortofolioById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await korjooService.UpdateApplicantPortofolio(Id, applicantPortofolio);
