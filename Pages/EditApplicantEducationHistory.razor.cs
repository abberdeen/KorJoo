...
{
    public partial class EditApplicantEducationHistory
    {
        [Inject]
        ...
        {
            applicantEducationHistory = await korjooService.GetApplicantEducationHistoryById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await korjooService.UpdateApplicantEducationHistory(Id, applicantEducationHistory);
