...
{
    public partial class EditApplicantSkill
    {
        [Inject]
        ...
        {
            applicantSkill = await korjooService.GetApplicantSkillById(Id);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await korjooService.UpdateApplicantSkill(Id, applicantSkill);
